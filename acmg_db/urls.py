...
urlpatterns = [
    path('', views.view_previous_classifications, name='home'), # change this to change home page
    ...
    path('view_previous_classifications', views.view_previous_classifications, name='view_previous_classifications'),   # list of all classifications
